...
- `@tanstack/react-query` is currently `5.51.1`
- `mssql-django` is currently `1.6`
...
| Package | Version | Purpose | Install Command |
|---------|---------|---------|-----------------|
| @tanstack/react-query | 5.51.1 | Server state | `npm install @tanstack/react-query@5.51.1` |
...
| Package | Version | Purpose | Install Command |
|---------|---------|---------|-----------------|
| recharts | 3.7.0 | Dashboard charts and trend visualizations | `npm install recharts@3.7.0` |
...
| vitest | 3.2.4 | Unit/integration test runner | `npm install -D vitest@3.2.4` |
| jsdom | 28.0.0 | Browser-like DOM test environment | `npm install -D jsdom@28.0.0` |
| @testing-library/react | 16.3.0 | React component testing | `npm install -D @testing-library/react@16.3.0` |
| @testing-library/user-event | 14.6.1 | User interaction testing | `npm install -D @testing-library/user-event@14.6.1` |
| @testing-library/jest-dom | 6.9.1 | DOM assertions | `npm install -D @testing-library/jest-dom@6.9.1` |
...
| mssql-django | 1.6 | SQL Server backend | `pip install mssql-django==1.6` |
...
|-----------|---------|-------|
| SQL Server | 2019+ | Current settings include a compatibility patch for SQL Server 2025 version detection |
| Database Name | `ksm_inspection` | Current backend default in `psc-backend/core/settings.py` |
| ODBC Driver | 18 | Current backend default is `ODBC Driver 18 for SQL Server` |
