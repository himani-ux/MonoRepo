...
5. Add a required description (minimum 5 characters)
6. Click **Upload**
...
5. In the current backend, upload permission is granted to office users generally; it is not limited only to PIC/DPA/SSQE in code
...
### Inspection CAR PDF ZIP Export

1. Open an inspection detail page
2. Use the export action for inspection CAR PDFs
3. The backend returns a ZIP containing all CAR PDF exports for that inspection
