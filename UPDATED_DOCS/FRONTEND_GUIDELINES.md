...
│   ├── login.tsx
│   ├── dashboard/index.tsx
│   ├── deficiencies/index.tsx
│   ├── inspections/index.tsx
│   ├── inspections/new.tsx
│   ├── inspections/[id].tsx
│   ├── inspections/[id].edit.tsx
│   ├── inspections/[id].follow-up.tsx
│   ├── cars/index.tsx
│   ├── cars/[id].tsx
│   ├── cars/[id].edit.tsx
...
Current routing/permission notes:

- `App.tsx` defines routes directly; there is no standalone `routes/index.tsx`
