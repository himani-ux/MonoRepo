...
DEFAULT_OFFICE_SLACK_CHANNEL = "#certs-office-fleet"
DEFAULT_DPA_SLACK_CHANNEL = "#certs-office-dpa"
DEFAULT_TECHNICAL_SLACK_CHANNEL = "#certs-office-tm"
DEFAULT_MARINE_SLACK_CHANNEL = "#certs-office-marine"
