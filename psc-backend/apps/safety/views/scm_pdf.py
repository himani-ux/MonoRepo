...
class SCMPDFDownloadView(SCMViewMixin, generics.GenericAPIView):
    lookup_url_kwarg = "id"
    ...
    def get_queryset(self):
        return self._apply_filters(SCMMeeting.objects.filter(is_deleted=False))
    ...
    def get(self, request, *args, **kwargs):
        ...
        result = self.get_pdf_renderer().render_scm_pdf(
