...
class IncidentCauseTag(PublicIdMixin):
    ...
    cause_factor = models.CharField(max_length=16, blank=True, null=True)
    cause_option_id = models.UUIDField(blank=True, null=True)
    cause_option_text = models.TextField(blank=True, default="")
    cause_other_text = models.TextField(blank=True, default="")
