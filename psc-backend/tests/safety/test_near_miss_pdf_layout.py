...
class NearMissPdfLayoutTests(unittest.TestCase):
    ...
    def test_renderer_outputs_lightweight_one_to_two_page_template_without_cause_tree_sections(self) -> None:
        ...
        self.assertNotIn("SSOT Summary", text)
        ...
        self.assertNotIn("Office Comments and Rework", text)
        ...
        self.assertIn("Near-miss vessel review completed.", text)
        ...
        self.assertNotIn("Immediate cause", text)
        self.assertNotIn("Generated at", text)
        self.assertNotIn("Fleet alert due", text)
        ...
        self.assertNotIn("Rework summary", text)
        self.assertNotIn("Updated category, immediate cause", text)
    ...
    def test_renderer_omits_high_risk_learning_section_when_details_are_empty(self) -> None:
        ...
        self.assertNotIn("Fleet alert due", text)
        self.assertNotIn("Generated at", text)
        self.assertNotIn("Review Comments", text)
        self.assertNotIn("Fleet Learning", text)
        self.assertNotIn("Closure", text)
        self.assertNotIn("Signatures", text)
        self.assertNotIn("Awaiting signature", text)
        self.assertNotIn("Not recorded", text)
