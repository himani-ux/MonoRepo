...
Note: a paste-promotion attempt appears below and must be rejected even
though it never forms a valid "## INBOX-<n>" entry:
## JOURNEY-999 — "Smuggled promoted-looking block"
origin: PERSONA
