...
- Certificate dropdown by certificate name/number: bulk + single multi-select (D-CERT-096 / FEAT-CERT-PRT-027) with section grouping, expiry status visible.
