...
| Preventive Action | Description, Due date, and How much will this reduce risk? are required. | Remaining risk, risk-confirmation checkbox, theme, effort, and "Prevent It Happening Again" wording are not user-facing under D-MAINT-CR049; legacy storage fields remain nullable compatibility data. |
...
| Rule ID | Trigger condition | Enforcement point | Error message | Decision ref |
|---------|-------------------|-------------------|---------------|--------------|
| V-INC-060 | Preventive Action missing `estimated_likelihood_reduction` or linked action due date | client + server | "Select how much the action will reduce risk and enter a due date." | D-GAP-R02; D-MAINT-CR049 |
...
| Visible Phase 6 → 7 | Office Review accepted by PIC or DPA for any risk band; optional Office Comments/lesson learnt saved without a word limit; PDF report issued where applicable. Send for rework uses a comment plus the fixed action-rework target. | D-PDF-01, D-MAINT-CR042, D-MAINT-CR043, D-MAINT-CR044, D-MAINT-CR049 |
