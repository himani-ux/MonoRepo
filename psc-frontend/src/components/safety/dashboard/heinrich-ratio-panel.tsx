      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
            Compares reports against the expected safety-reporting pattern.
          </p>
        </div>
        <div
          aria-label={`Confidence ${confidence.status}: ${confidence.tooltip}`}
          className={`rounded-md border px-4 py-3 text-sm ${confidenceClassNames[confidence.status]}`}
        ...
        >
          ...
          <div className="mt-2 leading-6">
            ...
            <div className="text-xs">
              Last 12 months: {confidence.incidentCount12m} incidents / {confidence.nearMissCount12m} near misses
            </div>
          </div>
        </div>
      </div>
