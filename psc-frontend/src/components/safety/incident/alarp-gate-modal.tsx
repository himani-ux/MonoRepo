...
export function SafetyAlarpGateModal({
  ...
  return (
    <section className="rounded-3xl border border-amber-300 bg-amber-50 p-5 shadow-sm">
      ...
      <h2 className="mt-2 text-xl font-semibold text-amber-950">Prevention check needed</h2>
      <p className="mt-3 text-sm leading-6 text-amber-900">
        {blockingRows} prevention row
        {blockingRows === 1 ? "" : "s"} still need work needed, risk reduction,
        remaining risk, and confirmation before Office Review can issue the report.
      </p>
