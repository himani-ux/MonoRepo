...
10. [ ] BLOCKED: Resolve B-P9-02 mapping/catalog treatment before Phase 9.2 FM go-live.
...
`B-P9-01` is RESOLVED and Phase 9.1 writes are complete. `B-P9-02` is OPEN: class snapshots parsed, but live class-code mappings are empty, KR live snapshot survey keys require reparse after the parser normalization fix, and class-tracked catalog rows need DPA/technical mapping/catalog treatment before Phase 9.2 go-live.
