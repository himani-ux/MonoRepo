...
Session status: BLOCKED on `docsuite/BLOCKERS.md` B-P9-05 after certificate evidence review.
...
11. [ ] BLOCKED: Prince/DPA must provide the remaining VIMS Certificates Module training completion package before Phase 9.5 can be completed.
