...
|--------|---------|--------|
| Submit credentials | Click Login | Validate → Success: Redirect to /inspections |
...
| Status | Vessel Master | Office | DPA |
|--------|---------------|--------|-----|
| DRAFT | Edit, Submit | Edit-assist | - |
| SUBMITTED | - | Edit, Accept, Rework | Rework |
| PIC_ACCEPTED | - | - | Close, Rework |
| REWORK_REQUESTED | Edit, Submit | Edit | Edit |
| DPA_CLOSED | - | - | Reopen |
