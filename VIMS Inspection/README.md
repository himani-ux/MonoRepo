...
psc-backend/
  ...
  apps/
    ...
    inspection/       # Inspections + Deficiencies
...
|--------|-----|---------------|
| `/api/psc/auth/` | accounts | login, refresh, me |
| `/api/psc/inspections/` | inspection | CRUD, submit, review, close |
| `/api/psc/deficiencies/` | inspection | action-code update |
| `/api/psc/cars/` | car | CRUD, submit, accept, rework, close |
...
- **CAR lifecycle:** DRAFT > SUBMITTED > PIC_ACCEPTED > DPA_CLOSED (with rework loop)
...
- **Export:** CAR PDF, Deficiency Excel
