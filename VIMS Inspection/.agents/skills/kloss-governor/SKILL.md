---
name: kloss-governor
description: "Enforce Kloss standards: read the referenced spec file first, execute only the requested phase, cite repo evidence for every claim, and stop on missing inputs."
---
